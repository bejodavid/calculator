...
int A;
if(A==2) {System.out.println("Welcome to the realise scedule.  ");
...
if(A==1){System.out.println("Welcome to the calculator. For now you can only + or - but if you want to know when you can calculate more complex eqasions chek the realise schedule");
  System.out.println("Press + or - depending on wich eqaison you want to do");
